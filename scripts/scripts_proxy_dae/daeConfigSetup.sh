...
# 重载配置（修改配置后使用）
sudo systemctl enable dae.service || { echo "Failed to reload service"; exit 1; }

sudo systemctl start dae.service || { echo "Failed to reload service"; exit 1; }
...
#基础状态
systemctl is-active dae.service
